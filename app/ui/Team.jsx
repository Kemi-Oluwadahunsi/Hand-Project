...
const Team = () => {
  return (
    <div className="flex flex-col gap-[5rem] px-[7rem] pb-[10rem]">
      ...
      <div className="flex justify-between gap-8">
        <div className="flex flex-col gap-8 p-4 shadow-[0px_0px_10px_rgba(0,0,0,0.2)] pb-8">
          ...
          <div>
            <h3 className="font-bold text-[2rem] ">Esther Howard</h3>
            <p className="text-zinc-400 text-[1.5rem] font-semibold">Founder</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 p-4 shadow-[0px_0px_10px_rgba(0,0,0,0.2)] pb-8">
          ...
          <div>
            <h3 className="font-bold text-[2rem] ">Cody Fisher</h3>
            <p className="text-zinc-400 text-[1.5rem] font-semibold">
              Developer
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 px-4 pt-4 shadow-[0px_0px_10px_rgba(0,0,0,0.2)] pb-8">
          ...
          <div>
            <h3 className="font-bold text-[2rem] ">Brooklyn Simmons</h3>
            <p className="text-zinc-400 text-[1.5rem] font-semibold">
              Designer
            </p>
          </div>
