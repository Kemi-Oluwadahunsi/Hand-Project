...
const Metrics = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full bg-black h-auto lg:h-[12rem] xl:h-[15rem] gap-8 lg:gap-0 justify-between px-8 lg-px-[3rem] xl:px-[5rem] py-8 lg:py-0 lg:pt-[3rem] xl:pt-[4rem] ">
      {data.map((item, index) => (
